...
if (isset($_GET['action']) && $_GET['action'] === 'delete' && isset($_GET['id'])) {
    ...
    $deleteQuery = "DELETE FROM spending WHERE id = '$id' AND user_id = '$userId'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'update') {
        ...
        $query = "UPDATE spending SET date = '$date', notes = '$notes', amount = '$amount' WHERE id = '$id' AND user_id = '$userId'";
    } else {
        $query = "INSERT INTO spending (user_id, date, notes, amount) VALUES ('$userId', '$date', '$notes', '$amount')";
    }
...
$searchCondition = '';
if (!empty($search)) {
    $searchCondition = " AND (spending.notes LIKE '%$search%' OR spending.amount LIKE '%$search%' OR spending.date LIKE '%$search%')";
}

$totalQuery = "SELECT COUNT(*) AS total FROM spending WHERE user_id = '$userId' $searchCondition";
...
if (isset($_GET['get_transaction'])) {
    ...
    $query = "SELECT * FROM spending WHERE id = '$id' AND user_id = '$userId'";
    $result = mysqli_query($conn, $query);
...
<head>
    ...
    <title>SARUAKI FINANCE | Spending</title>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar py-4">
            ...
            <nav class="nav flex-column px-3">
                ...
                <a href="spending.php" class="nav-link active">
        ...
        <div class="content p-4 flex-grow-1">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="navbar">
                    <h6>Pages / <span class="text-warning">Spending</span></h6>
                </div>
                <div class="dropdown">
            ...
            <div class="container-table">
                <div class="header">
                    <h2 style="font-weight: bold;">Spending</h2>
                </div>
                    ...
                    <div class="content">
                        ...
                        <div class="form">
                            <form method="POST" action="">
                                ...
                                <div class="mb-3">
                                    <label for="amount" class="form-label">Amount of Spending</label>
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="spending.php?action=delete&id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this transaction?');">
                    ...
                    <div class="content">
                        ...
                        <div class="form">
                            <form method="POST" action="">
                                ...
                                <div class="mb-3">
                                    <label for="edit-amount" class="form-label">Amount of Spending</label>
            ...
            <script>
                ...
                function toggleEditPopup(id) {
                    ...
                    if (popup.classList.contains("active")) {
                        ...
                        fetch(`spending.php?get_transaction=${id}`)
