...
if (isset($_GET['action']) && $_GET['action'] === 'delete' && isset($_GET['id'])) {
    ...
    $deleteQuery = "DELETE FROM debt WHERE id = '$id' AND user_id = '$userId'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'update') {
        ...
        $query = "UPDATE debt SET date = '$date', kreditur = '$kreditur', notes = '$notes', amount = '$amount' WHERE id = '$id' AND user_id = '$userId'";
    } else {
        $query = "INSERT INTO debt (user_id, date, kreditur, notes, amount) VALUES ('$userId', '$date', '$kreditur', '$notes', '$amount')";
    }
...
$searchCondition = '';
if (!empty($search)) {
    $searchCondition = " AND (debt.notes LIKE '%$search%' OR debt.amount LIKE '%$search%' OR debt.date LIKE '%$search%' OR debt.kreditur LIKE '%$search%')";
}

$totalQuery = "SELECT COUNT(*) AS total FROM debt WHERE user_id = '$userId' $searchCondition";
...
if (isset($_GET['get_transaction'])) {
    ...
    $query = "SELECT * FROM debt WHERE id = '$id' AND user_id = '$userId'";
    $result = mysqli_query($conn, $query);
    ...
    <div class="d-flex">
        ...
        <div class="content p-4 flex-grow-1">
            ...
            <div class="container-table">
                <div class="header">
                    <h2 style="font-weight: bold;">Debt</h2>
                </div>
                    ...
                    <div class="content">
                        ...
                        <div class="form">
                            <form method="POST" action="">
                                ...
                                <div class="mb-3">
                                    <label for="amount" class="form-label">Amount of Debt</label>
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($row['kreditur']); ?></td>
                                    <td><?php echo htmlspecialchars($row['notes']); ?></td>
                                    <td><?php echo 'Rp ' . number_format(floatval($row['amount']), 0, ',', '.'); ?></td>
                                    <td>
                                        <a href="debt.php?action=delete&id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this transaction?');">
                    ...
                    <div class="content">
                        ...
                        <div class="form">
                            <form method="POST" action="">
                                ...
                                <div class="mb-3">
                                    <label for="edit-amount" class="form-label">Amount of Debt</label>
            ...
            <script>
                ...
                function toggleEditPopup(id) {
                    ...
                    if (popup.classList.contains("active")) {
                        ...
                        fetch(`debt.php?get_transaction=${id}`)
                            .then(response => response.json())
                            .then(data => {
                                document.getElementById('edit-id').value = id;
                                document.getElementById('edit-date').value = data.date;
                                document.getElementById('edit-kreditur').value = data.kreditur;
